...
def parse_args():
    ...
    parser.add_argument('--antialiasing', action='store_true',
                        help='use blur pool for strided(2) convolutions. default is false.')
    parser.add_argument('--antialiasing-filter-size', type=int, default=3,
                        help='antialiasing kernel size. default is 3.')
...
def main():
    ...
    kwargs = {'classes': classes, 'context': context,
              'antialias': opt.antialiasing, 'filter_size': opt.antialiasing_filter_size}
